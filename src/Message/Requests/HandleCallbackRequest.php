...
use Omnipay\AzeriCard\Message\Responses\HandleCallbackResponse;

/**
 * Handle AzeriCard callback for sale completion.
 */
class HandleCallbackRequest extends AbstractRequest
{
    /**
    ...
    {
        return $this->response = new HandleCallbackResponse($this, $data);
    }
    ...
    {
        $required = ['AMOUNT', 'TERMINAL', 'APPROVAL', 'RRN', 'INT_REF'];
